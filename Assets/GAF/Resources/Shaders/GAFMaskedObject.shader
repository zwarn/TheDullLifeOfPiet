Shader "GAF/GAFMaskedObject"
{
	Properties
	{
		...
		_Color("Per vertex color", Color) = (1.0, 1.0, 1.0, 1.0 )
		_Offset("Per vertex color offset", Vector) = (0.0, 0.0, 0.0, 0.0 )
	}
	...
	SubShader 
	{
		...
		{			
			...
			o.Albedo = ( mainColor.rgb * _Color.rgb + _Offset.rgb );
			o.Alpha  = ( mainColor.a   * _Color.a   + _Offset.a   ) * maskColor.a;
		}
