...
{
	public class GAFMaskedObjectImpl : GAFObjectImpl
	{
		#region Members
		...
		protected override void updateColor(GAFObjectStateData _State, GAFRenderProcessor _Processor, bool _Refresh)
		{
			...
			{
				updateMaterialData(_State, _Refresh);	
			}
		}

		private void updateMaterialData(GAFObjectStateData _State, bool _Refresh)
		{
				...
				_Refresh)
			{
				...
				renderer.sharedMaterial.SetColor("_Color", color);
				renderer.sharedMaterial.SetVector("_Offset", colorsShift[0]);
