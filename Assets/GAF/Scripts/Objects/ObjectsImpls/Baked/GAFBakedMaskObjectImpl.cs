...
{
	public class GAFBakedMaskObjectImpl : GAFBakedObjectImpl
	{
		#region Members
		...
		public override void updateToState(GAFObjectStateData _State, GAFRenderProcessor _Processor, bool _Refresh)
		{
			...
			float scale = serializedProperties.clip.settings.pixelsPerUnit / serializedProperties.clip.settings.scale;
